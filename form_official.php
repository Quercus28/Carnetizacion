                ...
                <div class="signup-content">
                    <form action="save_official.php" method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <input type="text" name="in_carnet_type" class="form-control"
                                    placeholder="Tipo de carnet" style="resize:none;" required>
                            </div>
                            <div class="form-group">
                                <input type="number" name="in_cost" class="form-control" placeholder="Costo"
                                    style="resize:none;" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="in_pay_method" class="form-control"
                                    placeholder="Método de pago" style="resize:none;" required>
                            </div>
